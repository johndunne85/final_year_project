...
names_data = pd.read_csv('tight_turn.csv')
...
#
# torch.save(model.state_dict(),'checkpoint_tight_turn.pth')

state_dict_tig_turn = torch.load('checkpoint_tight_turn.pth')

model.load_state_dict(state_dict_tig_turn)

def test_cards_tig_turn(card):
    with torch.no_grad():
