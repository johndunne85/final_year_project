...
#   ******************** here *********************
    ...
    did_win = 'win'
    did_loss = 'loss'
    jhand1 = player_1_with_flop[0]
    jhand2 = player_1_with_flop[1]
    jhand3 = player_1_with_flop[2]
    jhand4 = player_1_with_flop[3]
    jhand5 = player_1_with_flop[4]
    jhand_flop = jhand1+','+jhand2+','+jhand3+','+jhand4+','+jhand5
